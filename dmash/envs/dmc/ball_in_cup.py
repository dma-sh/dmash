...
def update_physics(xml_string, gravity=9.81, distance=0.3, action_factor=1.0):
    """
    ...
    delta_distance = default_distance - distance
    distance = " ".join(["0", str(distance)])
...
def catch(time_limit=_DEFAULT_TIME_LIMIT, random=None, environment_kwargs=None, context_kwargs=None):
    ...
    task = BallInCup(random=random, action_factor=action_factor)
