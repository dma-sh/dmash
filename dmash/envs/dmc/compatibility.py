...
from dmash.envs.dmc.utils import dm_env_step2gym_step, dm_spec2gym_space
...
class DmControlCompatibilityV0(gymnasium.Env[ObsType, np.ndarray], EzPickle):
    ...
    def __init__(
        ...
        self._context = context_kwargs or {}
        self._context_low = {
            k: [-np.inf for vi in v] if isinstance(v, list) else -np.inf
