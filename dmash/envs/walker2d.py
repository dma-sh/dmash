    ...
    * v0: Initial versions release
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.model.opt.gravity = np.array([0., 0., -gravity], dtype=np.float64)
        self.model.actuator_gear *= actuator_strength
